...
// general images
  ...
  static String shoppingBasket = "$bagImagesPath/shopping_basket_2.png";
  static String shoppingBasket2 = "$bagImagesPath/shopping_basket.png";
  ...
  static String banner3 = "$bannersImagesPath/banner3.jpeg";
  static String banner4 = "$bannersImagesPath/banner4.jpeg";
  static String banner5 = "$bannersImagesPath/banner5.jpeg";
  static String banner6 = "$bannersImagesPath/banner6.jpeg";
  static String banner7 = "$bannersImagesPath/banner7.jpeg";
  static String banner8 = "$bannersImagesPath/banner8.jpeg";
  // Categories path
